...
export const GENERATE_EXAMPLES: PromptExample[] = [
  ...
  },
  {
    ...
    output:
      "A solid geometric shield with clean beveled edges containing a subtle upward-pointing arrow integrated into the negative space. Bold uppercase sans-serif brand name below in heavy weight. Corporate institutional style with authoritative symmetry. Deep navy blue with silver metallic accents. Vector logo, flat design, scalable, single icon, centered composition, professional branding, no background clutter.",
  },
  {
    input: "healthcare, caring",
    output:
      "A continuous flowing line forming both a heart and a leaf shape in a single graceful stroke, conveying life and wellness. Rounded sans-serif brand name below in medium weight with generous letter spacing. Soft modern style with smooth organic curves. Calming teal green with soft white. Vector logo, flat design, scalable, single icon, centered composition, professional branding, no background clutter.",
  },
  {
    input: "gaming, bold",
    output:
      "An angular stylized dragon head built from sharp interlocking geometric shards with aggressive forward-leaning posture. Bold italic sans-serif brand name slashed diagonally beneath. Esports style with dynamic angular energy and hard edges. Electric crimson red with deep black and subtle neon orange accents. Vector logo, flat design, scalable, single icon, centered composition, professional branding, no background clutter.",
  },
];
